...
namespace LibraryManagementSystem
{
    ...
    public static class LibraryData
    {
        ...
        private static void InitializeData()
        {
            ...
            Books = new List<Book>
            {
                new Book { Id = 1, Title = "Clean Code", Genre = "Programming", AuthorId = 1, PublishedYear = 2008, IsAvailable = true, Price = 50m },
                ...
                new Book { Id = 5, Title = "Domain-Driven Design", Genre = "Programming", AuthorId = 3, PublishedYear = 2003, IsAvailable = false, Price = 50m },
